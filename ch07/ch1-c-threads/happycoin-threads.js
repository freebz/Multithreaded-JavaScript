...
var wasmBinaryFile;
  wasmBinaryFile = 'happycoin-threads.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],init:function() {
        ...
        var pthreadMainJs = locateFile('happycoin-threads.worker.js');
...
var proxiedFunctionTable = [null,exitOnMainThread,_emscripten_set_canvas_element_size_main_thread,_fd_write];
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 2704;
